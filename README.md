...
- **Remote dev tools**
  ...
  - notes: Since remote devtools is made for redux on the web (which this app is neither), the buttons at the bottom of the devtools do not and will not work with Flutter. For the purpose of using with this app, remote devtools is useful to explore the events that have been dispatched and the current state of AppDb.
